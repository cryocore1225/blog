  ...
  return (
    <style jsx global>{`
      ...
      :root {
        ...
        --claude-code-text: #24292e;
        --claude-code-token-comment: #6a737d;
        --claude-code-token-punctuation: #24292e;
        --claude-code-token-keyword: #d73a49;
        --claude-code-token-string: #032f62;
        --claude-code-token-number: #005cc5;
        --claude-code-token-function: #6f42c1;
        --claude-code-token-operator: #d73a49;
        --claude-code-token-class-name: #6f42c1;
        --claude-code-token-attr-name: #6f42c1;
        --claude-code-token-tag: #22863a;
        --claude-code-token-property: #005cc5;
        --claude-code-token-atrule: #d73a49;
        --claude-code-token-url: #032f62;
        --claude-code-token-variable: #e36209;
        --claude-code-token-important: #d73a49;
        --claude-code-token-entity: #22863a;
        --claude-code-token-css-string: #032f62;
        ...
        --claude-gh-font-family: 'Noto Sans SC', -apple-system, system-ui, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji';
        ...
        --claude-heading-font: 'Noto Serif SC', 'Source Han Serif SC', 'PingFang SC', Georgia, 'Times New Roman', serif;
        --claude-body-font: 'Noto Sans SC', 'PingFang SC', 'Microsoft YaHei', 'Hiragino Sans GB', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif;
      ...
      html[data-theme='dark'] {
        ...
        --claude-code-text: #c9d1d9;
        --claude-code-token-comment: #8b949e;
        --claude-code-token-punctuation: #c9d1d9;
        --claude-code-token-keyword: #ff7b72;
        --claude-code-token-string: #a5d6ff;
        --claude-code-token-number: #79c0ff;
        --claude-code-token-function: #d2a8ff;
        --claude-code-token-operator: #ff7b72;
        --claude-code-token-class-name: #d2a8ff;
        --claude-code-token-attr-name: #d2a8ff;
        --claude-code-token-tag: #7ee787;
        --claude-code-token-property: #79c0ff;
        --claude-code-token-atrule: #ff7b72;
        --claude-code-token-url: #a5d6ff;
        --claude-code-token-variable: #ffa657;
        --claude-code-token-important: #ff7b72;
        --claude-code-token-entity: #7ee787;
        --claude-code-token-css-string: #a5d6ff;
