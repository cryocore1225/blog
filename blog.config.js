...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'claude', // 当前主题，在themes文件夹下可找到所有支持的主题
  ...
  REVALIDATION_TOKEN: process.env.REVALIDATION_TOKEN || 'blogreval2026', // On-Demand Revalidation Token，设置后可通过 POST /api/revalidate 立即刷新页面缓存（解决 Notion 内容更新延迟问题）
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '写写代码，记记笔记 ☕', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://25565.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.svg', // blog favicon 配置, 默认使用 /public/favicon.svg
